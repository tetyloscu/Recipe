...
"""
title,rating,calories,protein,fat,sodium,#cakeweek,#wasteless,22-minute meals,3-ingredient recipes,30 days of groceries,advance prep required,
alabama,alaska,
alcoholic,
...
class Recipe(models.Model):
  ...
  meal_type = models.CharField(max_length=255, null=True, blank=True) # dinner supper etc
  recipe_type = models.CharField(max_length=255, null=True, blank=True) # chef, diet type, alcoholic or not
  location = models.CharField(max_length=255, null=True, blank=True)
  holiday_type = models.CharField(max_length=255, null=True, blank=True)
  cooking_method  = models.CharField(max_length=255, null=True, blank=True) # steam fry etc.
